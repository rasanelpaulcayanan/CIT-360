	...
	public static void main(String[] args) {
        ...
        while (!isValid) {
            try {
        		...
        		//Prints the course code and course name
        		...
        		//The course code is used as key in map and the course name serves as the value
